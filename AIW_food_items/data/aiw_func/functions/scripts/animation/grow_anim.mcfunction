execute as @a[scores={AIW_small_fixed_1=4..}] run scoreboard players set tresbola AIW_small_fixed_1 0
execute as @a[scores={AIW_grow_cake=1..}] run scoreboard players add tresbola AIW_scale 1

execute as @a[scores={AIW_grow_cake=1..}] run scoreboard players set tresbola AIW_anim_timer 1
...
execute as @a[scores={AIW_grow_cake=1..}] run scoreboard players add tresbola AIW_small_fixed_1 1
