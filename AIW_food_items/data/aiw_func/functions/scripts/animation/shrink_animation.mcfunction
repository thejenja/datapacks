...
execute as @a[scores={AIW_shrink_drink=1..}] run say 4

execute as @a[scores={AIW_shrink_drink=1..}] run scoreboard players add @s AIW_big_fixed_1 1
execute as @a[scores={AIW_shrink_drink=1..}] run say 5

execute as @a[scores={AIW_scale=..2}] run say 6
...
execute as @a[scores={AIW_big_fixed_1=4..}] run say 7

execute as @a[scores={AIW_shrink_drink=1..,AIW_anim_timer=2..}] run say 8
execute as @a[scores={AIW_shrink_drink=1..,AIW_anim_timer=2..}] run scoreboard players set @s AIW_anim_timer 0


execute as @a[scores={AIW_shrink_drink=1..,AIW_anim_timer=2..}] run function aiw_func:scripts/animation/shrink_animation
execute as @a[scores={AIW_shrink_drink=1..,AIW_anim_timer=2..}] run say 9