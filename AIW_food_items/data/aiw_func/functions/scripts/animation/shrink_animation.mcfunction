execute as @a[scores={AIW_big_fixed_1=4..}] run scoreboard players set tresbola AIW_big_fixed_1 0
execute as @a[scores={AIW_shrink_drink=1..}] run scoreboard players remove tresbola AIW_scale 1

execute as @a[scores={AIW_shrink_drink=1..}] run scoreboard players set tresbola AIW_anim_timer 1
...
execute as @a[scores={AIW_shrink_drink=1..}] run scoreboard players add tresbola AIW_big_fixed_1 1
