execute as @a[scores={AIW_scale=11..}] run scoreboard players remove @s AIW_scale 1

execute as @a[scores={AIW_scale=10..}] run scoreboard players set @s AIW_anim_timer 1
